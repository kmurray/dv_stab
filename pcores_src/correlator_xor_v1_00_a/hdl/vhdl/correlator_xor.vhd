------------------------------------------------------------------------------
-- correlator_xor.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
entity correlator_xor is
  ...
  (
    ...
    --USER ports added here
      bram_read_data_0              : in std_logic_vector (127 downto 0);
      bram_read_data_1              : in std_logic_vector (127 downto 0);
      bram_read_data_2              : in std_logic_vector (127 downto 0);
      bram_read_data_3              : in std_logic_vector (127 downto 0);
      bram_read_data_4              : in std_logic_vector (127 downto 0);
      bram_read_data_5              : in std_logic_vector (127 downto 0);
      bram_read_data_6              : in std_logic_vector (127 downto 0);
      bram_read_data_7              : in std_logic_vector (127 downto 0);
      bram_read_data_8              : in std_logic_vector (127 downto 0);
      bram_read_data_9              : in std_logic_vector (127 downto 0);
      bram_read_data_10             : in std_logic_vector (127 downto 0);
      bram_read_data_11             : in std_logic_vector (127 downto 0);
      bram_read_data_12             : in std_logic_vector (127 downto 0);
      bram_read_data_13             : in std_logic_vector (127 downto 0);
...
end entity correlator_xor;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of correlator_xor is
  ...
  constant INTR_BASEADDR                  : std_logic_vector     := C_BASEADDR or X"00001100";
  constant INTR_HIGHADDR                  : std_logic_vector     := C_BASEADDR or X"000011FF";
