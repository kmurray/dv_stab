...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\Dropbox\ece532\PROJECT_TEST\correlator\correlator_proj\motion_corr_plb
  logical library name                       : correlator_xor_v1_00_a
  top name                                   : correlator_xor
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
Address Block for User Logic and IPIF Predefined Services
  ...
  software reset space                       : C_BASEADDR + 0x00001000
                                             : C_BASEADDR + 0x000010FF
  interrupt control space                    : C_BASEADDR + 0x00001100
                                             : C_BASEADDR + 0x000011FF
...
- XPS interface file(s)
  ...
  data/correlator_xor_v2_1_0.mpd
  ...
  data/correlator_xor_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/correlator_xor.ise
...
- XST synthesis file(s)
  ...
  devl/synthesis/correlator_xor_xst.prj
...
- Driver interface file(s)
  ...
  data/correlator_xor_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/correlator_xor_v2_1_0.tcl
...
plbv46_slave_single_v1_00_a
	C:\Dropbox\ece532\PROJECT_TEST\correlator\correlator_proj\motion_corr_plb\C:\Xilinx\10.1\EDK\hw\XilinxProcessorIPLib\pcores\plbv46_slave_single_v1_00_a\doc\plbv46_slave_single.pdf

interrupt_control_v2_00_a
	C:\Dropbox\ece532\PROJECT_TEST\correlator\correlator_proj\motion_corr_plb\C:\Xilinx\10.1\EDK\hw\XilinxProcessorIPLib\pcores\interrupt_control_v2_00_a\doc\interrupt_control.pdf
