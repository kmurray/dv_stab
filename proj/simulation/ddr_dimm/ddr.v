...
`endif
    ...
    // DQS Buffer
    assign /*#1*/ Dqs = Dqs_out;

    reg         [DQ_BITS - 1 : 0] Dqobuf;

    // DQ Buffer
    assign /*#1*/ Dq  = Dqobuf;

	always @(Dq_out) Dqobuf = #5 Dq_out;

	//always @ (Dq_out)
	//begin
		//Dq[DQ_BITS - 1 : 0] = Dq_out[DQ_BITS - 1 : 0];
	//end
